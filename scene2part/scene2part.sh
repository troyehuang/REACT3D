...
python inference_ram_plus.py --image_dir ${data_dir}/images_2 --pretrained ${CODE_DIR}/ram++/ram_plus_swin_large_14m.pth
...
python s2p_5.py --data_dir ${data_dir} --mesh_path ${data_dir}/mesh_aligned_0.05.ply --image_dir ${data_dir}/images_2 --depth_dir ${data_dir}/depth

python s2p_6.py -d ${data_dir}
